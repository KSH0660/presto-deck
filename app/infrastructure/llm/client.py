...
class LLMClient:
    ...
    async def generate_slide_content(
        ...
        try:
            ...
            # Create chain with structured output
            chain = SLIDE_CONTENT_PROMPT | self.client.with_structured_output(SlideContent)
            ...
            logger.error("Failed to generate slide content", slide_number=slide_number, error=str(e))
    ...
    async def update_slide_content(
        ...
        try:
            ...
            # Create chain with structured output
            chain = SLIDE_UPDATE_PROMPT | self.client.with_structured_output(SlideContent)
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                if attempt < self.max_retries - 1:
                    ...
                    logger.error("All chain invocation retry attempts failed", error=str(e))
        
        raise LLMException(f"Chain invocation failed after {self.max_retries} attempts: {last_exception}")
