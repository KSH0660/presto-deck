...
async def presentation_generator(
    request: PresentationRequest, presentation_service: PresentationService
):
...
async def generate_presentation_stream(
    ...
    presentation_service = PresentationService(
        template_service, resource_service
    )  # Pass resource_service
    return StreamingResponse(
        presentation_generator(request, presentation_service),
