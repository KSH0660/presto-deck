...
async def test_websocket_event_replay_scenario():
    ...
    historical_events = [
        ...
        {"event_type": "SlideAdded", "version": 3, "payload": {"slide_id": str(uuid4()), "slide_order": 1}},
        {"event_type": "SlideAdded", "version": 4, "payload": {"slide_id": str(uuid4()), "slide_order": 2}},
    ]
    ...
    missed_events = [
        ...
        if event["version"] > client_last_version
    ]
    ...
    replayed_events.append({
        ...
        "data": {"replayed_events": len(missed_events)}
    })
